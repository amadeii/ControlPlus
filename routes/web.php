...
Route::middleware(['verificaEmpresa', 'validaPlano', 'validaContrato'])->group(function () {
    ...
    Route::get('auditoria-operacional', 'AuditoriaOperacionalController@index')->name('auditoria-operacional.index');
    ...
    Route::post('trade-in/inventory/{id}/assistencia', 'TradeinInventoryController@enviarParaAssistencia')->name('tradein.inventory.assistencia');
    Route::post('trade-in/inventory/{id}/aprovar-venda', 'TradeinInventoryController@aprovarParaVenda')->name('tradein.inventory.aprovar-venda');
    ...
    Route::get('assistencia', function (\Illuminate\Http\Request $request) {
        return redirect()->route('ordem-servico.index', $request->query());
    })->middleware('permission:ordem_servico_view');

    Route::group(['prefix' => 'ordem-servico'], function () {
        Route::get('/assistencia/fila-tecnica', 'OrdemServicoController@assistenciaFilaTecnica')->name('ordem-servico.fila-tecnica');
        Route::get('/assistencia/painel', 'OrdemServicoController@assistenciaPainel')->name('ordem-servico.painel-assistencia');
        Route::post('/{id}/assistencia-controle', 'OrdemServicoController@assistenciaAtualizarControle')->name('ordem-servico.assistencia-controle');
        Route::post('/{id}/assistencia-checklist', 'OrdemServicoController@assistenciaAlternarChecklist')->name('ordem-servico.assistencia-checklist');
        ...
        Route::get('/documento/{id}', 'OrdemServicoController@downloadDocumento')->name('ordem-servico.download-documento');
        ...
        Route::get('/aparelho-interno-seriais', 'OrdemServicoController@aparelhoInternoSeriais')->name('ordem-servico.aparelho-interno-seriais');
    ...
    Route::get('reparo-interno/seriais-disponiveis', 'ReparoInternoController@serialsDisponiveis')->name('reparo-interno.serials');
    Route::post('reparo-interno/{id}/linha', 'ReparoInternoController@storeLinha')->name('reparo-interno.linha.store');
    Route::delete('reparo-interno/linha/{id}', 'ReparoInternoController@destroyLinha')->name('reparo-interno.linha.destroy');
    Route::post('reparo-interno/{id}/finalizar', 'ReparoInternoController@finalizar')->name('reparo-interno.finalizar');
    Route::post('reparo-interno/{id}/cancelar', 'ReparoInternoController@cancelar')->name('reparo-interno.cancelar');
    Route::post('reparo-interno/{id}/em-andamento', 'ReparoInternoController@marcarEmAndamento')->name('reparo-interno.em-andamento');
    Route::resource('reparo-interno', 'ReparoInternoController')->only(['index', 'create', 'store', 'show', 'update']);
    Route::resource('assistencia-estoque-ajuste', 'AssistenciaEstoqueAjusteManualController')->only(['index', 'create', 'store', 'show']);
    ...
    Route::group(['prefix' => 'relatorios'], function () {
        ...
        Route::get('assistencia-os-pecas', 'RelatorioController@assistenciaOsPecas')->name('relatorios.assistencia-os-pecas');
        Route::get('assistencia-perdas-operacionais', 'RelatorioController@assistenciaPerdasOperacionais')->name('relatorios.assistencia-perdas-operacionais');
        Route::get('assistencia-resumo-operacional', 'RelatorioController@assistenciaResumoOperacional')->name('relatorios.assistencia-resumo-operacional');
        Route::get('assistencia-tradein-custo-agregado', 'RelatorioController@assistenciaTradeinCustoAgregado')->name('relatorios.assistencia-tradein-custo-agregado');
        Route::get('assistencia-lucro-pos-reparo', 'RelatorioController@assistenciaLucroPosReparo')->name('relatorios.assistencia-lucro-pos-reparo');
        Route::get('assistencia-pecas-mais-utilizadas', 'RelatorioController@assistenciaPecasMaisUtilizadas')->name('relatorios.assistencia-pecas-mais-utilizadas');
        Route::get('assistencia-por-tecnico', 'RelatorioController@assistenciaPorTecnicoResponsavel')->name('relatorios.assistencia-por-tecnico');
        Route::get('assistencia-os-internas', 'RelatorioController@assistenciaOsInternas')->name('relatorios.assistencia-os-internas');
        Route::get('assistencia-dashboard-operacional', 'RelatorioController@assistenciaDashboardOperacional')->name('relatorios.assistencia-dashboard-operacional');
