...
<body>
    <div class="row">
        <h4 style="text-align:center; margin-top: -50px;">Ordem de Produção</h4>
        <h5 style="text-align:center; margin-top: -20px;">Número: {{ $item->codigo_sequencial }}</h5>
        @if ($item->observacao)
            <h5 style="margin-left: 15px">Observação: <strong>{{ $item->observacao }}</strong></h5>
        @endif
        @if ($item->funcionario)
    ...
    <table>
        <thead>
            <tr>
                ...
                <td class="" style="width: 100px; text-align: left;">
                    Nº Pedido
                </td>
                <td class="" style="width: 260px; text-align: left;">
                    Cliente
                </td>
                <td class="" style="width: 120px; text-align: left;">
                    Quantidade
                </td>
                <td class="" style="width: 200px; text-align: left;">
                    Observação
                </td>
            </tr>
        </thead>
        <tbody>
            @foreach ($item->itens as $i)
                <tr>
                    ...
                    <td style="text-align: left;">{{ $i->observacao }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
