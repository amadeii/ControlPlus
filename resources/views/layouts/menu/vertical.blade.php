            ...
            @if (!__isMaster())
                ...
                @if (__isActivePlan(Auth::user()->empresa, 'Serviços'))
                    @canany(['ordem_servico_view', 'ordem_servico_create', 'produtos_view', 'metas_view', 'reparo_interno_view', 'reparo_interno_create', 'assistencia_estoque_ajuste_view', 'assistencia_estoque_ajuste_create'])
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarAssistenciaTecnica" aria-expanded="false"
                                aria-controls="sidebarAssistenciaTecnica" class="side-nav-link">
                                <i class="ri-customer-service-2-line"></i>
                                <span> Assistência técnica </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebarAssistenciaTecnica">
                                <ul class="side-nav-second-level">

                                    @can('ordem_servico_view')
                                        <li>
                                            <a href="{{ route('ordem-servico.index') }}">Todas as OS</a>
                                        </li>
                                        @php
                                        ...
                                        @if($__assistTpl)
                                        <li>
                                            <a href="{{ route('ordem-servico.fila-tecnica') }}">Fila técnica</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('ordem-servico.painel-assistencia') }}">Painel assistência</a>
                                        </li>
                                        @endif
                                    @endcan
                                    ...
                                    @can('produtos_view')
                                        <li>
                                            <a href="{{ route('produtos.index') }}">Peças</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('reparo_interno_view')
                                        <li>
                                            <a href="{{ route('reparo-interno.index') }}">Reparo interno</a>
                                        </li>
                                    @endcan
                                    @can('reparo_interno_create')
                                        <li>
                                            <a href="{{ route('reparo-interno.create') }}">Novo reparo interno</a>
                                        </li>
                                    @endcan

                                    @can('assistencia_estoque_ajuste_view')
                                        <li>
                                            <a href="{{ route('assistencia-estoque-ajuste.index') }}">Baixas manuais (perdas)</a>
                                        </li>
                                    @endcan
                                    @can('assistencia_estoque_ajuste_create')
                                        <li>
                                            <a href="{{ route('assistencia-estoque-ajuste.create') }}">Nova baixa manual</a>
                                        </li>
                                    @endcan
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarGestaoPessoal">
                                <ul class="side-nav-second-level">
                                    ...
                                    @can('logs_view')
                                        <li>
                                            <a href="{{ route('auditoria-operacional.index') }}">Auditoria operacional</a>
                                        </li>
                                    @endcan
