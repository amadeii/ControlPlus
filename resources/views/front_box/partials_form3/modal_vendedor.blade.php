    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Selecione o consultor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::select('vendedor', 'Consultor', ["" => "Selecione"] + $funcionarios->pluck('nome', 'id')->all())
                        ->id('vendedor')
                        ->value(isset($item) ? $item->funcionario_id : null)
                        ->attrs(['class' => 'select-vendedor', 'data-cargo-context' => 'comercial']) !!}
                    </div>
