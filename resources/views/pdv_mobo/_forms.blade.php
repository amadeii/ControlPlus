...
<div class="px-1">
    ...
    <div class="pdv-search-wrapper">
        <input type="text" id="buscarProduto" class="form-control pdv-search" placeholder="Buscar produto..."
            autocomplete="off">
    ...
    <div id="reader"
        style="width:100%; height:280px; display:none; border-radius:10px; overflow:hidden; position:relative; margin-top:10px;">
    </div>
...
<input type="hidden" id="tipo_divisao_pizza"
    value="{{ $configCardapio != null ? $configCardapio->valor_pizza : 'divide' }}">
