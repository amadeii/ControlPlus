	...
	<main class="container py-4">
		<div class="card card-os">
			<div class="card-body">
				...
				@if($ordem->equipamento || $ordem->marca_equipamento || $ordem->modelo_equipamento || $ordem->numero_serie)
				
				<div class="row mb-3">
					<div class="col-md-3 col-6"><strong>Equipamento:</strong><br>{{ $ordem->equipamento ?: '—' }}</div>
					<div class="col-md-3 col-6"><strong>Marca:</strong><br>{{ $ordem->marca_equipamento ?: '—' }}</div>
					<div class="col-md-3 col-6"><strong>Modelo:</strong><br>{{ $ordem->modelo_equipamento ?: '—' }}</div>
					<div class="col-md-3 col-6"><strong>IMEI / Série:</strong><br>{{ $ordem->numero_serie ?? '—' }}</div>
					<div class="col-md-3 col-6 mt-2"><strong>Cor:</strong><br>{{ $ordem->cor ?? '—' }}</div>
				</div>
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered mt-2">
						...
						<tbody>
							...
							<tr>
								<td data-label="Produto">{{ $item->descricaoLinha() }}</td>
