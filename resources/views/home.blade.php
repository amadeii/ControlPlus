            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <span class="small text-muted" id="label-tipo-data-vendas-esq" style="font-size:12px;">Data de
                            Cadastro</span>
                        <div class="form-check form-switch mb-0 mx-1">
                            <input class="form-check-input" type="checkbox" role="switch" id="toggle-tipo-data-vendas"
                                style="cursor:pointer; width:2.4em; height:1.2em;">
                        </div>
                        <span class="small text-muted" id="label-tipo-data-vendas-dir" style="font-size:12px;">Data de
                            Faturamento</span>
                    </div>
                </div>
                ...
                <div class="row g-2 mb-2">
                    <div class="col-6">
                        <div class="rounded p-3" style="background:#daeef8;">
                            ...
                            <div class="fw-bold text-dark" id="vendas-total-chart" style="font-size:1.15rem;">R$ 0,00
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="rounded p-3" style="background:#f0f0f0;">
                            ...
                            <div class="fw-bold text-dark" id="vendas-ticket-chart" style="font-size:1.15rem;">R$ 0,00
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <a href="{{ route('nfe.create') }}" class="btn btn-primary w-100 fw-semibold"
                            style="letter-spacing:.5px;">
                            NOVA VENDA
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{ route('relatorios.index') }}" class="btn btn-primary w-100 fw-semibold"
                            style="letter-spacing:.5px;">
                            RELATÓRIOS DE VENDA
                        </a>
                    </div>
                            ...
                            y: {
                                ...
                                ticks: {
                                    ...
                                    callback: function(value) {
                                        if (value >= 1000000) return (value / 1000000).toFixed(1).replace('.0',
                                            '') + 'M';
