...
function __createLog($empresa_id, $local, $acao, $descricao, array $extras = [])
{
    $ctx = AuditRequestContext::capture();
    $payload = array_key_exists('payload', $extras) ? $extras['payload'] : null;
    ...
    AcaoLog::create([
        ...
        'local' => $local,
        'acao' => $acao,
        'descricao' => is_string($descricao) ? $descricao : (string) $descricao,
        'user_id' => $ctx['user_id'],
