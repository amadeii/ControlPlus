...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_nota_servicos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('nota_servico_id')->nullable()->index('item_nota_servicos_nota_servico_id_foreign');
            $table->unsignedBigInteger('servico_id')->nullable()->index('item_nota_servicos_servico_id_foreign');
