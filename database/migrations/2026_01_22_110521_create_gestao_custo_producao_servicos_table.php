...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('gestao_custo_producao_servicos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('gestao_custo_id')->index('gestao_custo_producao_servicos_gestao_custo_id_foreign');
            $table->unsignedBigInteger('servico_id')->index('gestao_custo_producao_servicos_servico_id_foreign');
