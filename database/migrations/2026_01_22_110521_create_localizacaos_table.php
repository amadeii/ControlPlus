...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('localizacaos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('empresa_id')->nullable()->index('localizacaos_empresa_id_foreign');
            $table->string('descricao', 150);
            $table->boolean('status')->default(true);
            $table->string('nome', 150)->nullable();
            $table->mediumText('nome_fantasia')->nullable();
            ...
            $table->unsignedBigInteger('cidade_id')->nullable()->index('localizacaos_cidade_id_foreign');
