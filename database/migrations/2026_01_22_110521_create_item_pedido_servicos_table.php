...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('item_pedido_servicos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('pedido_id')->index('item_pedido_servicos_pedido_id_foreign');
            $table->unsignedBigInteger('servico_id')->index('item_pedido_servicos_servico_id_foreign');
